...
def create_light_presentation():
    ...
    COLOR_BG = RGBColor(248, 250, 252)       # Light slate/off-white background #F8FAFC
    COLOR_CARD = RGBColor(255, 255, 255)     # Pure white cards #FFFFFF
    COLOR_BORDER = RGBColor(226, 232, 240)   # Subtle border #E2E8F0
    COLOR_CYAN = RGBColor(8, 145, 178)       # Deep Cyan #0891B2
    COLOR_BLUE = RGBColor(37, 99, 235)       # Royal Blue #2563EB
    COLOR_EMERALD = RGBColor(5, 150, 105)    # Emerald #059669
    COLOR_AMBER = RGBColor(217, 119, 6)      # Dark Amber #D97706
    COLOR_ROSE = RGBColor(225, 29, 72)       # Deep Rose #E11D48
    COLOR_TEXT = RGBColor(15, 23, 42)        # Dark Slate Primary Text #0F172A
    COLOR_MUTED = RGBColor(71, 85, 105)      # Medium Slate Muted Text #475569
    ...
    def add_header(slide, badge_text, title_text, subtitle_text=""):
        ...
        badge.fill.solid()
        badge.fill.fore_color.rgb = RGBColor(236, 254, 255) # Light Cyan tint
    ...
    # Save presentation
    output_path = r"d:\CE\sem5\SGP\Ai based evaluation sheet\presentation\presentation_deck_light.pptx"
    prs.save(output_path)
    print(f"Light theme presentation saved successfully to {output_path}")
